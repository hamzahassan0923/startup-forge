    ...
    return (
        <section className="relative w-full min-h-screen bg-slate-50 text-slate-900 overflow-hidden flex items-center justify-center py-16 px-4 sm:px-8">
            ...
            <div className="absolute inset-0 pointer-events-none z-0 opacity-60">
                <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-linear-to-br from-blue-200 via-purple-100 to-transparent rounded-full blur-[120px]" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-linear-to-tr from-red-100 via-amber-100 to-transparent rounded-full blur-[100px]" />
            </div>
            ...
            <div className="container mx-auto max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-6 flex flex-col items-center w-full">
                    ...
                    <div className="relative w-full aspect-16/10 rounded-4xl p-1 bg-linear-to-b from-white to-slate-200 shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden group perspective-1000">
                        ...
                        {/* Accent Bottom Bar */}
                        <div className="absolute bottom-0 inset-x-0 h-1 bg-linear-to-r from-blue-600 via-purple-600 to-red-500" />
                    </div>
                        ...
                        {steps.map((step, idx) => (
                            <React.Fragment key={idx}>
                                <button
                                    ...
                                    className={`text-xs md:text-sm font-bold transition-all duration-300 px-3 py-1.5 rounded-lg ${idx === activeIndex
                ...
                <div className="lg:col-span-6 flex flex-col justify-center space-y-6 lg:pl-6 text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-2">
                        ...
                        <button className="px-8 py-4 bg-linear-to-r from-red-500 to-orange-500 text-white font-bold rounded-xl transition-all duration-200 uppercase tracking-wider text-xs shadow-md shadow-red-500/20 hover:brightness-105">
